            ...
            >
              ...
              >
                ...
                <p className={`transition-colors duration-300 ${
                  benefit.highlight 
                    ? 'text-blue-100' 
                    : 'text-blue-800 group-hover:text-blue-100'
                }`}>
                  {benefit.description}
                </p>
              </Card>
        ...
        >
          <div className="inline-flex items-center gap-6 bg-white rounded-full px-8 py-6 shadow-lg hover:shadow-2xl hover:bg-blue-50 transition-all duration-300 cursor-pointer group">
            <div className="text-left">
              ...
              <div className="text-sm text-blue-700 group-hover:text-blue-500 transition-colors duration-300">Average rating of 4.9/5 stars</div>
            </div>
