      ...
      <div className="container mx-auto px-4">
        ...
        >
          <Card className="text-center p-6 hover:bg-blue-600 hover:text-white transition-all duration-300 cursor-pointer group hover:shadow-xl">
            ...
            <div className="text-slate-900 group-hover:text-blue-100 transition-colors duration-300">Average Rating</div>
          ...
          <Card className="text-center p-6 hover:bg-blue-600 hover:text-white transition-all duration-300 cursor-pointer group hover:shadow-xl">
            ...
            <div className="text-slate-900 group-hover:text-blue-100 transition-colors duration-300">Happy Clients</div>
          </Card>
          <Card className="text-center p-6 hover:bg-blue-600 hover:text-white transition-all duration-300 cursor-pointer group hover:shadow-xl">
            <div className="text-3xl font-bold text-blue-600 group-hover:text-white transition-colors duration-300">98%</div>
            <div className="text-slate-900 group-hover:text-blue-100 transition-colors duration-300">Success Rate</div>
          </Card>
          <Card className="text-center p-6 hover:bg-blue-600 hover:text-white transition-all duration-300 cursor-pointer group hover:shadow-xl">
            <div className="text-3xl font-bold text-blue-600 group-hover:text-white transition-colors duration-300">$500M+</div>
            <div className="text-slate-900 group-hover:text-blue-100 transition-colors duration-300">Total Recovered</div>
          </Card>
        </motion.div>
              ...
              <Card className="p-8 md:p-12 relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-slate-900 text-sm">{currentTestimonial.date}</span>
                  </div>

                  {/* Testimonial Text */}
                  <p className="text-lg md:text-xl text-slate-900 mb-6 italic">
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 mb-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-slate-900">Case Type</p>
                        <p className="font-semibold">{currentTestimonial.caseType}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm text-slate-900">Settlement</p>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-slate-900">{currentTestimonial.location}</p>
                    </div>
                  </div>
                </div>
              </Card>
